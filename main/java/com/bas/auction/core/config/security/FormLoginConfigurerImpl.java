...
public class FormLoginConfigurerImpl<H extends HttpSecurityBuilder<H>>
        extends
        AbstractAuthenticationFilterConfigurer<H, FormLoginConfigurerImpl<H>, UsernamePasswordAuthenticationFilter> {
    /**
     * Creates a new instance
     *
     * @see HttpSecurity#formLogin()
     */
    public FormLoginConfigurerImpl(UsernamePasswordAuthenticationFilter usernamePasswordAuthenticationFilter) {
        super(usernamePasswordAuthenticationFilter, null);
     ...
     * {@link UsernamePasswordAuthenticationFilterExt}:
     * </p>
     * <p>
     * <ul>
     ...
     * <p>
     * <pre>
     * <!-- loginProcessingUrl should correspond to FormLoginConfigurerImpl#loginProcessingUrl. Don't forget to perform a POST -->
     * &lt;c:url value="/login" var="loginProcessingUrl"/&gt;
     * &lt;form action="${loginProcessingUrl}" method="post"&gt;
     *    &lt;fieldset&gt;
     *        &lt;legend&gt;Please Login&lt;/legend&gt;
     *        &lt;!-- use param.error assuming FormLoginConfigurerImpl#failureUrl contains the query parameter error --&gt;
     ...
     *                  "/login")
     * @return the {@link FormLoginConfigurerImpl} for additional customization
     */
    public FormLoginConfigurerImpl<H> loginPage(String loginPage) {
     ...
     * @return the {@link FormLoginConfigurerImpl} for additional customization
     */
    public FormLoginConfigurerImpl<H> usernameParameter(String usernameParameter) {
     ...
     * @return the {@link FormLoginConfigurerImpl} for additional customization
     */
    public FormLoginConfigurerImpl<H> passwordParameter(String passwordParameter) {
